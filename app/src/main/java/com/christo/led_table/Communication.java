...
//    }
    ...
    private void setBTArrow(String direction)
    {
        //ensure there is a handler connected
        if (mUIHandler == null)
            return;
        ...
        msg.arg1 = mUIHandlerArg1;
        msg.arg2 = UI_HANDLER_ARG2_BLUETOOTH_ARROW;
        mUIHandler.sendMessage(msg);
    }
