...
//        Drawable d = ContextCompat.getDrawable(this,R .drawable.smart_lock);
//        Drawable currentState = d.getCurrent();
//        Bitmap b = ((BitmapDrawable)currentState).getBitmap();
//
//        final int imgSize = (int)((double)NVM_device.getInstance().getDisplayWidth()*(double)0.5);
//        Bitmap scaledBmp = Bitmap.createScaledBitmap(b, imgSize, imgSize, false);
//
//        BitmapDrawable scaledBmpdrawable = new BitmapDrawable(getResources(), scaledBmp);
//        scaledBmpdrawable.setAlpha(80);
//        scaledBmpdrawable.setGravity(Gravity.CENTER);
//        getListView().setBackground(scaledBmpdrawable);
        ...
        public void onLeScan(final BluetoothDevice bluetoothDevice, final int rssi, byte[] bytes)
        {
            runOnUiThread(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    {
                        //check if the device should autoconnect
                        if(bluetoothDevice.getAddress().equals(mBTAddress))
